...
- Name: smoke/smoke.spec.ts >> Pricing page >> pricing page renders without error
- Location: tests/smoke/smoke.spec.ts:29:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3847/pricing
Call log:
  - navigating to "http://localhost:3847/pricing", waiting until "load"
