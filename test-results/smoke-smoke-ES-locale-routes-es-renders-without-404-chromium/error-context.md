...
- Name: smoke/smoke.spec.ts >> ES locale routes >> /es renders without 404
- Location: tests/smoke/smoke.spec.ts:47:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3847/es
Call log:
  - navigating to "http://localhost:3847/es", waiting until "load"
