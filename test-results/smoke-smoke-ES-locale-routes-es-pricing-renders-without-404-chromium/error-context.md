...
- Name: smoke/smoke.spec.ts >> ES locale routes >> /es/pricing renders without 404
- Location: tests/smoke/smoke.spec.ts:53:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3847/es/pricing
Call log:
  - navigating to "http://localhost:3847/es/pricing", waiting until "load"
